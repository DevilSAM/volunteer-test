...
let app = new Vue({
    ...
    template: `
        <div class='start-game-block' v-if='startScreen'>
            <div class='container'>
                <h4>Правила теста</h4>
                <p>Это тест на знание фильма <b>The Terminator</b> 1984 года</p>
                <p>Вам будет предложено 10 вопросов, непосредственно относящихся к этому фильму.</p>
                <p>Вы должны выбрать один из 4 предложенных вариантов ответа.</p>
                <p>После выбора будет сразу показан правильный ответ, так что пройти тест честно можно только 1 раз.</p>
                <p><i>Удачи!</i></p>
            </div>
